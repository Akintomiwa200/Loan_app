...
const Hero = () => {
  useEffect(() => {
    ...
    AOS.refresh(); // Refresh AOS after rendering
  }, []); // Add an empty dependency array to prevent multiple re-renders

  return (
    <div>
      <div className={styles.hero_Display_Container}>
        <div className={styles.hero_Text_Box} data-aos="fade-right" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center">
        ...
        <img src={HeroImg} alt="" className={styles.heroImg} data-aos="fade-left" data-aos-offset="200" data-aos-delay="20" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center" />
      </div>
